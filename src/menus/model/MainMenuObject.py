...
class MainMenuObject(CVNinjaObject):
    ...
    def _get_images_vertices(self):
        ...
        self.broken_images_sporadic = self._get_spliced_image_vertices_combo(3, True)
    ...
    def spawn_object(self, space, collision_type, position=(50,50)):
        body = pymunk.Body(body_type=pymunk.Body.STATIC)#1, float('inf'))
    ...
    def collision_aftermath(self, space, shape, contact_point = (0,0), sound = CVAssets.AUDIO_ROCK_SMASH):
        ...
        for piece in self.broken_images_sporadic:
