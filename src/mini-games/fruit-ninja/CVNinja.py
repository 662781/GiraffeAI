...
class CVNinja(CVGame):
     def __init__(self):
          ...
          self.wood = cv2.imread('resources/plank.png', cv2.IMREAD_UNCHANGED)
          self.stone = cv2.imread('resources/rock.png', cv2.IMREAD_UNCHANGED)
          self.bomb = cv2.imread('resources/bomb.png', cv2.IMREAD_UNCHANGED)
