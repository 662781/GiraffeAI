...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    ...
    while video_capture.isOpened():
        ...
        try:
            ...
            cx, cy = int(landmarks[mp_pose.PoseLandmark.LEFT_INDEX.value].x * width), int(
            ...
            cv2.putText(image, "Stage: " + stage + " " + str(int(number_of_jabs)), (10, 70), cv2.FONT_HERSHEY_PLAIN, 3,
                        (255, 0, 255), 3)
